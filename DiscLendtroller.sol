...
// Dependency file: contracts/DiscLendtrollerStorage.sol
...
contract DiscLendtrollerV1Storage is UnitrollerAdminStorage {
...
contract DiscLendtrollerV2Storage is DiscLendtrollerV1Storage {
    struct Market {
...
contract DiscLendtrollerV3Storage is DiscLendtrollerV2Storage {
...
contract DiscLendtrollerV4Storage is DiscLendtrollerV3Storage {
...
contract DiscLendtrollerV5Storage is DiscLendtrollerV4Storage {
...
contract DiscLendtrollerV6Storage is DiscLendtrollerV5Storage {
...
contract DiscLendtrollerV7Storage is DiscLendtrollerV6Storage {
...
// import "contracts/ErrorReporter.sol";
// import "contracts/DiscLendtrollerStorage.sol";
/**
 * @title ComptrollerCore
 * @dev Storage for the comptroller is at this address, while execution is delegated to the `comptrollerImplementation`.
 * CTokens should reference this contract as their comptroller.
 */
contract Unitroller is UnitrollerAdminStorage, DiscLendtrollerErrorReporter {
...
// Dependency file: contracts/Governance/DiscLendToken.sol

// pragma solidity ^0.5.16;
pragma experimental ABIEncoderV2;

contract DiscLendToken {
    /// @notice EIP-20 token name for this token
    string public constant name = "DiscLend";
    ...
    /// @notice Total number of tokens in circulation
    uint public constant totalSupply = 1000000e18; // 1 million Comp
...
// Root file: contracts/DiscLendtrollerG7.sol
...
// import "contracts/Governance/DiscLendToken.sol";

/**
 * @title Compound's Comptroller Contract
 * @author Compound
 */
contract DiscLendtroller is DiscLendtrollerV5Storage, DiscLendtrollerInterface, DiscLendtrollerErrorReporter, ExponentialNoError {
    ...
    function grantCompInternal(address user, uint amount) internal returns (uint) {
        DiscLendToken discLendToken = DiscLendToken(getCompAddress());
        uint compRemaining = discLendToken.balanceOf(address(this));
        if (amount > 0 && amount <= compRemaining) {
            discLendToken.transfer(user, amount);
            return 0;
        }
        return amount;
    }
    ...
    function getCompAddress() public pure returns (address) {
        return 0xA9D6E20E67A2C6306570925ccA64A2460FeF918c;
    }
}