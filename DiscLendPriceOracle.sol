// Dependency file: contracts/DiscLendPriceOracle/interfaces/IUniswapV2Factory.sol
...
// Dependency file: contracts/DiscLendPriceOracle/interfaces/IUniswapV2Pair.sol
...
// Dependency file: contracts/DiscLendPriceOracle/interfaces/IUniswapV2ERC20.sol
...
// Dependency file: contracts/DiscLendtrollerInterface.sol

// pragma solidity ^0.5.16;

contract DiscLendtrollerInterface {
...
// import "contracts/DiscLendtrollerInterface.sol";
...
contract CTokenStorage {
     ...
     */
    DiscLendtrollerInterface public comptroller;
...
contract CTokenInterface is CTokenStorage {
     ...
     */
    event NewComptroller(DiscLendtrollerInterface oldComptroller, DiscLendtrollerInterface newComptroller);
    ...
    function _setComptroller(DiscLendtrollerInterface newComptroller) public returns (uint);
...
contract DiscLendtrollerErrorReporter {
    enum Error {
        NO_ERROR,
        UNAUTHORIZED,
...
contract CToken is CTokenInterface, Exponential, TokenErrorReporter {
     ...
     */
    function initialize(DiscLendtrollerInterface comptroller_,
    ...
    function _setComptroller(DiscLendtrollerInterface newComptroller) public returns (uint) {
        ...
        DiscLendtrollerInterface oldComptroller = comptroller;
...
// Dependency file: contracts/DiscLendErc20.sol
 ...
 * @author Compound
 */
contract DiscLendErc20 is CToken, CErc20Interface {
    /**
    ...
    function initialize(address underlying_,
                        DiscLendtrollerInterface comptroller_,
                        InterestRateModel interestRateModel_,
                        uint initialExchangeRateMantissa_,
                        string memory name_,
                        string memory symbol_,
...
// Dependency file: contracts/DiscLendPriceOracle/FixedPoint.sol
...
// Dependency file: contracts/DiscLendPriceOracle/UniswapV2OracleLibrary.sol

// pragma solidity ^0.5.16;

// import 'contracts/DiscLendPriceOracle/interfaces/IUniswapV2Pair.sol';
// import 'contracts/DiscLendPriceOracle/FixedPoint.sol';
...
// Dependency file: contracts/DiscLendPriceOracle/UniswapV2Library.sol
...
// Root file: contracts/DiscLendPriceOracle/DiscLendPriceOracle.sol

pragma solidity ^0.5.16;

// import 'contracts/DiscLendPriceOracle/interfaces/IUniswapV2Factory.sol';
// import 'contracts/DiscLendPriceOracle/interfaces/IUniswapV2Pair.sol';
// import 'contracts/DiscLendPriceOracle/interfaces/IUniswapV2ERC20.sol';
// import 'contracts/PriceOracle.sol';
// import "contracts/DiscLendErc20.sol";

// import 'contracts/DiscLendPriceOracle/UniswapV2OracleLibrary.sol';
// import 'contracts/DiscLendPriceOracle/UniswapV2Library.sol';
// import 'contracts/DiscLendPriceOracle/FixedPoint.sol';


contract DiscLendPriceOracle is PriceOracle {
    ...
    constructor() public {
        iUniswapV2Factory = IUniswapV2Factory(0x152eE697f2E276fA89E96742e9bB9aB1F2E61bE3);
        owner = msg.sender;
    ...
    function updatePairPrices(address _pair, address _token) external onlyGovernor {
        ...
        if(_token == oraclePairMapping[_pair].token0){
            ...
            emit PricePosted(_token, prices[_token], token0Price);
            prices[_token] = token0Price;
    ...
    function _getUnderlyingAddress(CToken cToken) private view returns (address) {
        address asset;
        if (compareStrings(cToken.symbol(), "dFTM")) {
            asset = address(0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83); //wFTM
        } else {
            asset = address(DiscLendErc20(address(cToken)).underlying());
        }
        return asset;
    }
